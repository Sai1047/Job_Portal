...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <!-- Header End -->
            ...
            <div class="container">
                <!-- <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Select Login Type</h1> -->
                <div class="row g-4">
                    <div class="col-12">
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.1s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <a href="register-candidates.php"><span class='mx-auto fw-bolder'>Candidate Register</span></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="d-flex align-items-center bg-light rounded p-4">
                                    ...
                                    <a href="register-company.php"><span class='mx-auto fw-bolder'>Company Register</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="copyright">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a class="border-bottom" href="#">jobportal.com</a>, All Right Reserved.

                            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                            Designed By <a class="border-bottom" href="#">Saiful</a>
                        </div>
